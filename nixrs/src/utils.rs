...
pub(crate) unsafe extern "C" fn get_string_cb(start: *const libc::c_char, n: libc::c_uint, user_data: *mut libc::c_void) {
...
pub(crate) unsafe extern "C" fn build_cb(map: *mut libc::c_void, out: *const libc::c_char, path: *const libc::c_char) {
